...
void fitEfficiency(float thres,
		   float mLow=45, float mHigh=70, double fit_cuts_min=16, double fit_cuts_max=150,
		   TString cutdef="pt_HLT>=20", TString cut_choice="HLT", TString Run="2012A",
		   ...
		   TString fileIn="*.root", TString image="eff_HLT_MuTau")
{
  ...
  // BINNING //
  const int nbinsEB_2012A = 15, nbinsEB_2012B = 17, nbinsEE_2012A = 15, nbinsEE_2012B = 17;

  Double_t binsEB_2012A[nbinsEB_2012A] = {10., 14., 18., 20., 22., 26., 30., 40., 50., 60., 70., 80, 90, 100, 120};
  Double_t binsEB_2012B[nbinsEB_2012B] = {10., 14., 18., 20., 22., 26., 30., 40., 50., 60., 70., 80, 90, 100, 120, 140, 160};
  Double_t binsEE_2012A[nbinsEE_2012A] = {10., 14., 18., 20., 22., 26., 30., 40., 50., 60., 70., 80, 90, 100, 120};
  Double_t binsEE_2012B[nbinsEE_2012B] = {10., 14., 18., 20., 22., 26., 30., 40., 50., 60., 70., 80, 90, 100, 120, 140, 160};

  RooBinning binningEB_2012A = RooBinning(nbinsEB_2012A-1, binsEB_2012A, "binningEB_2012A");
  RooBinning binningEB_2012B = RooBinning(nbinsEB_2012B-1, binsEB_2012B, "binningEB_2012B");
  RooBinning binningEE_2012A = RooBinning(nbinsEE_2012A-1, binsEE_2012A, "binningEE_2012A");
  RooBinning binningEE_2012B = RooBinning(nbinsEE_2012B-1, binsEE_2012B, "binningEE_2012B");

  RooBinning binningEB, binningEE;
  if(Run=="2012A") { 
    binningEB=binningEB_2012A; 
    binningEE=binningEE_2012A; 
  }
  else if(Run=="2012B") { 
    binningEB=binningEB_2012A; 
    binningEE=binningEE_2012A; 
