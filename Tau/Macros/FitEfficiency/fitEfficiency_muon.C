		   ...
		   TString fileIn="*.root", TString image="eff_HLT_MuTau")
{
  ...
  // BINNING //
  const int nbinsEB = 17;
  Double_t binsEB[nbinsEB] = {10., 14., 18., 20., 22., 26., 30., 40., 50., 60., 70., 80, 90, 100, 115, 130, 145};
  RooBinning binningEB = RooBinning(nbinsEB-1, binsEB, "binningEB");

  const int nbinsEE = 17;
  Double_t binsEE[nbinsEE] = {10., 14., 18., 20., 22., 26., 30., 40., 50., 60., 70., 80, 90, 100, 115, 130, 145};
  RooBinning binningEE = RooBinning(nbinsEE-1, binsEE, "binningEE");

  // EB/EE eta cuts //
  TString etacutEB="eta>-1.6 && eta<1.6", etacutEE="eta<=-1.6 || eta>=1.6";
