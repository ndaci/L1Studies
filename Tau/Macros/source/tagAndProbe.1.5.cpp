...
#include "/home/llr/cms/ndaci/SKWork/macro/skEfficiency/analyzers/COMMON/baseFuncNad.1.7.h"
#include "selection.1.2.1.h"

// Treelists                                                                                                                     
#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/SingleMu/MuTau/Run2012A_PRV1_2/treelist.h"
#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/SingleMu/MuTau/Run2012B_PRV1_2/treelist.h"

#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/SingleEle/Run2012A_PRV1_2/treelist.h"
#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/SingleEle/Run2012B_PRV1_2/treelist.h"

#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/MonteCarlo/DYjetsLL_EleTau/treelist.h"
#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/MonteCarlo/DYjetsLL_MuTau/treelist.h"
//#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/MonteCarlo/QCD_MuEnr_MuTau/treelist.h"
#include "/data_CMS/cms/ndaci/ndaci_2012/HTauTau/TriggerStudy/MonteCarlo/WjetsLnu_MuTau/treelist.h"
		...
		bool debug=false)
{
  ...
  else if(data=="HTT_EleTau_2012A_PRV1") {
    treeList = list_HTT_EleTau_2012A_PRV1();
  }
  else if(data=="HTT_EleTau_2012B_PRV1") {
    treeList = list_HTT_EleTau_2012B_PRV1();
  }
  else if(data=="HTT_MC_DY_ele") {
    treeList = list_HTT_MC_DYjetsLL_EleTau();
  }
  else if(data=="HTT_MC_DY_mu") {
    treeList = list_HTT_MC_DYjetsLL_MuTau();
  }
  else if(data=="HTT_MC_Wjets_mu") {
    treeList = list_HTT_MC_WjetsLnu_MuTau();
  }
  else if(data=="HTT_Alex") {
    treeList = list_Alex();
  }
  /*
  else if(data=="HTT_MC_QCD") {
    treeList = ();
  }
  */
  else {
